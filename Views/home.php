...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>Assets/img/carnet.ico">
                        ...
                        <div class="col-lg-5">
                            <div class="card border-0 rounded-lg mt-5 sb-sidenav-dark">
                                <div class="card-header text-center ">
                                    <h3 class="font-weight my-4">Iniciar Sesion</h3>
                                    <img class="img-thumbnail" src="<?php echo base_url(); ?>Assets/img/carnet.jpg" width="80" >
                                </div>
                                <div class="card-body">
                                    <form action="<?php echo base_url(); ?>Usuarios/login" method="post" autocomplete="off">
                                        <div class="form-group">
                                            <strong class="text-white">Ingresar Usuario</strong>
                                            <input id="usuario" class="form-control" type="text" name="usuario" placeholder="Usuario">
                                        </div>
                                        <div class="form-group">
                                            <strong class="text-white">Ingresar Contraseña</strong>
